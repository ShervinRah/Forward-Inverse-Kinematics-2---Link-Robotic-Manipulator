...
class Run:
    def __init__(self, factory):
        ...
        self.L1 = 0.4  # lower arm length joint 2 and 4
        self.L2 = 0.39 # upper arm length join 4 and 6
    ...
    def run(self):
        ...
        # self.arm.go_to(joint number, radians(angle))
